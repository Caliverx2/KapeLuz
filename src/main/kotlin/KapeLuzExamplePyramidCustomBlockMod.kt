...
class PyramidCustomBlockMod : LewapMod {
    ...
    override fun onTickUI(game: KapeLuz) {
        radiusLabel?.text = "Radius: $radius"
    }

    override fun onRender3D(game: KapeLuz) {
    ...
    private fun renderPyramidAt(game: KapeLuz, bx: Int, by: Int, bz: Int) {
