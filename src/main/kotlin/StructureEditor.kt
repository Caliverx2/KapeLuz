...
class PaletteWindow(private val display: DemoDisplay) : JFrame("Paleta Barw") {
    ...
    init {
        ...
        iconImage = Toolkit.getDefaultToolkit().getImage(PaletteWindow::class.java.getResource("/icons/KapeLuzStructureEditor.png"))
...
fun main() {
    SwingUtilities.invokeLater {
        ...
        val frame = JFrame("StructureEditor.kt")
        frame.iconImage = Toolkit.getDefaultToolkit().getImage(display::class.java.getResource("/icons/KapeLuzStructureEditor.png"))
