...
interface LewapMod {
     ...
     */
    fun onBlockPlace(game: KapeLuz, x: Int, y: Int, z: Int, color: Int): Boolean {
        return false
    }
     ...
     */
    fun onTickUI(game: KapeLuz) {}

    /**
     * Wywoływane po wyrenderowaniu świata, ale przed UI.
     * Pozwala modom rysować własne obiekty 3D (np. linie, boxy).
     */
    fun onRender3D(game: KapeLuz) {}
}

/**
 * Zarządca modów.
 */
class ModLoader(private val game: KapeLuz, rootDir: File) {
